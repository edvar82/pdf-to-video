...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--short-pause", type=float, default=0.6, help="Duração de [short_pause] em segundos")
    parser.add_argument("--long-pause", type=float, default=1.2, help="Duração de [long_pause] em segundos")
